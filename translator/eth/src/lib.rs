...
pub fn transpile_program(
    ...
    let hir = HirTranslator::new(&contract, contract_flow.clone(), block_io.clone(), flags);
    let hir2 = HirTranslator2::new(&contract, contract_flow, block_io, flags);
...
pub fn translate_function(
    ...
    hir2_translator: &HirTranslator2,
    fun: &Function,
    contract_addr: U256,
    code_size: u128,
    flags: Flags,
