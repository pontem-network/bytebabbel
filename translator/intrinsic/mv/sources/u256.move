module self::u256 {
    use self::math::{overflowing_add_u64, read_u64, to_bytes_u64, split_u128, overflowing_sub_u64, leading_zeros_u64, write_u64};
    use self::du256::{DU256, get_d, zero_d, put_d};

    #[test_only]
    use self::du256::new_du256;
