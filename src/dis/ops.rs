...
pub fn read_next_byte<R: Read + AsRef<[u8]>>(cursor: &mut Cursor<R>) -> Result<(usize, Instruction), Error> {
	...
	let instruction = match opcode {
		...
		0x60 | 0x61 | 0x62 | 0x63 | 0x64 | 0x65 | 0x66 | 0x67 | 0x68 | 0x69 | 0x6a | 0x6b | 0x6c | 0x6d | 0x6e | 0x6f => {
			match read_n_bytes(cursor, 1 + (opcode & 0x0f) as usize) {
...
fn read_n_bytes<R: Read + AsRef<[u8]>>(cursor: &mut Cursor<R>, n: usize) -> Result<Vec<u8>, io::Error> {
...
impl Instruction {
	...
	pub fn reads_from_memory(&self) -> bool {
		match self {
			Self::MLoad | Self::Create | Self::Call | Self::StaticCall | Self::DelegateCall | Self::CallCode | Self::Return | Self::Revert => true,
			_ => false,
		}
	}
	...
	pub fn ends_basic_block(&self) -> bool {
		match self {
			Self::Return | Self::Stop | Self::Invalid | Self::SelfDestruct | Self::Revert | Self::Jump | Self::JumpIf => true,
			_ => false,
		}
	}
	...
	pub fn pops(&self) -> usize {
		match self {
			...
			Self::Shr |
			Self::Sar => 2,
			Self::AddMod | Self::MulMod | Self::CallDataCopy | Self::CodeCopy | Self::Create | Self::ReturnDataCopy | Self::Create2 => 3,
			Self::ExtCodeCopy => 4,
